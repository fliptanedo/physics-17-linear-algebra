...
% \flip{I am here}
% formal definition: Basis is a minimal set. The number of vectors is the dimension. 

% defiens what a column vector is. it is not a vector. it's the coefficients.
